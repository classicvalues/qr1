...
This will create an executable jar file **qr_artifact_and_gateway.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/qr_artifact_and_gateway.jar
